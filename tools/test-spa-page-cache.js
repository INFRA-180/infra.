...
const SHELL_CACHE = "infra-shell-20260807-audio388-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260807-audio388");
...
async function main() {
  ...
  console.log("audiofix388 SPA page-cache tests: ok");
}
