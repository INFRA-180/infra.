...
const SHELL_CACHE = "infra-shell-20260822-audio401-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260822-audio401");
...
async function main() {
  ...
  console.log("audiofix401 SPA page-cache tests: ok");
}
