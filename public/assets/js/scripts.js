window.INFRA_BUILD_TAG = "audiofix282-20260709";
try {
...
(function () {
  ...
  const LOCAL_CATALOG_VERSION = "audiofix282-20260709";
  ...
  const runtimeVersion = "audiofix282-20260709";
  ...
  const coverRuntimeApi = createCoverRuntimeApi();

  function createCoverRuntimeApi() {
    const module = window.InfraCovers && typeof window.InfraCovers === "object"
      ? window.InfraCovers
      : null;
    const factory = module && typeof module.createRuntime === "function"
      ? module.createRuntime
      : null;
    if (!factory) return createNoopCoverRuntimeApi();
    return factory({
      audioState,
      spaState,
      COVERS_CACHE_NAME,
      COVER_SESSION_PREPARE_ENABLED,
      COVER_SESSION_PREPARE_CONCURRENCY,
      PWA_COVER_PREPARE_LIMIT,
      ALBUM_COVER_IMAGE_CACHE_LIMIT,
      toAbsoluteUrlOrEmpty,
      toRuntimeAbsoluteUrl,
      normalizeAlbumTitle,
      getImagePreferredSrc,
      isMobilePwaCoverNavigation,
      isAlbumOpenUrl,
      choosePreferredSrcsetSource,
      getSpaPersistRoot,
  ...
  function createNoopCoverRuntimeApi() {
    return {
      getResourceTimingHint: function () { return {}; },
      logCoverRuntimeEvent: function () { return false; },
      primeLinkedAlbumCoverForPwa: function () { return ""; },
      releasePwaCoverHold: function () {},
      showPwaCoverHold: function () { return false; },
      showPwaHomeReturnHold: function () { return false; },
      rememberAlbumCoverImage: function () {},
      prepareAlbumCoversForSession: function () { return Promise.resolve(); },
      scheduleAlbumCoverCacheWarmup: function () {},
      optimizeAlbumCoverImage: function () {}
    };
  }

  function callCoverRuntime(name, args) {
    const fn = coverRuntimeApi && typeof coverRuntimeApi[name] === "function"
      ? coverRuntimeApi[name]
      : null;
    return fn ? fn.apply(coverRuntimeApi, args || []) : undefined;
  }

  function getResourceTimingHint() { return callCoverRuntime("getResourceTimingHint", arguments); }
  function logCoverRuntimeEvent() { return callCoverRuntime("logCoverRuntimeEvent", arguments); }
  function primeLinkedAlbumCoverForPwa() { return callCoverRuntime("primeLinkedAlbumCoverForPwa", arguments); }
  function releasePwaCoverHold() { return callCoverRuntime("releasePwaCoverHold", arguments); }
  function showPwaCoverHold() { return callCoverRuntime("showPwaCoverHold", arguments); }
  function showPwaHomeReturnHold() { return callCoverRuntime("showPwaHomeReturnHold", arguments); }
  function rememberAlbumCoverImage() { return callCoverRuntime("rememberAlbumCoverImage", arguments); }
  function prepareAlbumCoversForSession() { return callCoverRuntime("prepareAlbumCoversForSession", arguments); }
  function scheduleAlbumCoverCacheWarmup() { return callCoverRuntime("scheduleAlbumCoverCacheWarmup", arguments); }
  function optimizeAlbumCoverImage() { return callCoverRuntime("optimizeAlbumCoverImage", arguments); }
