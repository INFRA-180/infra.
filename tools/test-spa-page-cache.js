...
const SHELL_CACHE = "infra-shell-20260821-audio393-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260821-audio393");
...
async function main() {
  ...
  console.log("audiofix393 SPA page-cache tests: ok");
}
