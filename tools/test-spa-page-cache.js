...
const SHELL_CACHE = "infra-shell-20260802-audio381-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260802-audio381");
...
async function main() {
  ...
  console.log("audiofix381 SPA page-cache tests: ok");
}
