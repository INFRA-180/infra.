...
const SHELL_CACHE = "infra-shell-20260722-audio368-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260722-audio368");
...
async function main() {
  ...
  console.log("audiofix368 SPA page-cache tests: ok");
}
