...
const sandbox = {
  ...
  caches: {
    ...
    keys: () => Promise.resolve([
      ...
      "infra-shell-20260717-audio343-shell",
      "infra-shell-20260717-audio343-runtime"
    ]),
    delete: (name) => {
...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix343-20260717"));
  ...
  assert(!deletedCaches.includes("infra-shell-20260717-audio343-shell"));
  assert(!deletedCaches.includes("infra-shell-20260717-audio343-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260717-audio343");
