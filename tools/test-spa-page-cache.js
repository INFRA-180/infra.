...
const SHELL_CACHE = "infra-shell-20260722-audio367-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260722-audio367");
...
async function main() {
  ...
  console.log("audiofix367 SPA page-cache tests: ok");
}
