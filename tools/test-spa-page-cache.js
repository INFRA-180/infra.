...
const SHELL_CACHE = "infra-shell-20260822-audio399-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260822-audio399");
...
async function main() {
  ...
  console.log("audiofix399 SPA page-cache tests: ok");
}
