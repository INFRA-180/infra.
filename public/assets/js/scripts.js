window.INFRA_BUILD_TAG = "audiofix310-20260714";
try {
...
(function () {
  ...
  const LOCAL_CATALOG_VERSION = "audiofix310-20260714";
  ...
  const runtimeVersion = "audiofix310-20260714";
    ...
    navigator.serviceWorker.addEventListener("message", function (event) {
      ...
      trackAudioRuntimeEvent("served_from_prefetch", Object.assign(
        buildAudioMonitorPayload(getCurrentPlaylistTrack(), audioState.currentIndex, src),
        {
          ...
          status: Object.prototype.hasOwnProperty.call(data, "status") ? data.status : 200,
