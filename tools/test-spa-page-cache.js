...
const SHELL_CACHE = "infra-shell-20260821-audio394-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260821-audio394");
...
async function main() {
  ...
  console.log("audiofix394 SPA page-cache tests: ok");
}
