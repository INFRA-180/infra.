...
const sandbox = {
  ...
  caches: {
    ...
    keys: () => Promise.resolve([
      ...
      "infra-shell-20260718-audio353-shell",
      "infra-shell-20260718-audio353-runtime"
    ]),
    delete: (name) => {
...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix353-20260718"));
  assert(
  ...
  assert(!deletedCaches.includes("infra-shell-20260718-audio353-shell"));
  assert(!deletedCaches.includes("infra-shell-20260718-audio353-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260718-audio353");
