const VERSION = "infra-shell-20260830-audio410";
...
const CANONICAL_COVER_PATHS = new Set([
  ...
  "assets/music/responsive/anunnaki-cover-1200.webp",
  "assets/music/responsive/anunnaki-instru-6a799ef0-cover-1200.webp",
  "assets/music/responsive/asase-yaa-cover-1200.webp",
  "assets/music/responsive/aspasie-cover-1200.webp",
  "assets/music/responsive/ballades-cover-1200.webp",
  ...
  "assets/music/responsive/d-2-0141-560ec418-cover-1200.webp",
  ...
  "assets/music/responsive/h-1-008-cover-1200.webp",
  "assets/music/responsive/he-4-0026-cover-1200.webp",
  "assets/music/responsive/impression-cover-1200.webp",
  "assets/music/responsive/kali-cover-1200.webp",
  "assets/music/responsive/ldc13-cover-1200.webp",
  "assets/music/responsive/mami-wata-cover-1200.webp",
  "assets/music/responsive/moremi-ajasoro-cover-1200.webp",
  "assets/music/responsive/nahda-cover-1200.webp",
  "assets/music/responsive/naviguer-cover-1200.webp",
  "assets/music/responsive/osiris-cover-1200.webp",
  "assets/music/responsive/pbb-cover-1200.webp",
  "assets/music/responsive/peches-cover-1200.webp",
  "assets/music/responsive/rue-de-paris-cover-1200.webp",
  "assets/music/responsive/salam-cover-1200.webp",
  "assets/music/responsive/sanguin-cover-1200.webp",
  "assets/music/responsive/trou-noir-cover-1200.webp",
  "assets/music/responsive/v-23pi56-cover-1200.webp",
  "assets/music/responsive/voyager-cover-1200.webp"
]);
...
const SHELL_ASSETS = [
  "./",
  "./index.html",
  "./assets/css/styles.css?v=audiofix410-20260830",
  "./assets/js/covers.js?v=audiofix410-20260830",
  "./assets/js/favorites.js?v=audiofix410-20260830",
  "./assets/js/favorites-ui.js?v=audiofix410-20260830",
  "./assets/js/audio-visualizer.js?v=audiofix410-20260830",
  "./assets/js/transport-ui.js?v=audiofix410-20260830",
  "./assets/js/now-playing.js?v=audiofix410-20260830",
  "./assets/js/album-player-ui.js?v=audiofix410-20260830",
  "./assets/js/spa-renderer.js?v=audiofix410-20260830",
  "./assets/js/audio-radio.js?v=audiofix410-20260830",
  "./assets/js/media-session.js?v=audiofix410-20260830",
  "./assets/js/audio-prefetch.js?v=audiofix410-20260830",
  "./assets/js/spa-router.js?v=audiofix410-20260830",
  "./assets/js/catalog-fallback.js?v=audiofix410-20260830",
  "./assets/js/catalog-loader.js?v=audiofix410-20260830",
  "./assets/js/audio-telemetry.js?v=audiofix410-20260830",
  "./assets/js/downloads.js?v=audiofix410-20260830",
  "./assets/js/home-catalog.js?v=audiofix410-20260830",
  "./assets/js/audio-core.js?v=audiofix410-20260830",
  "./assets/js/pwa-install.js?v=audiofix410-20260830",
  "./assets/js/share-qr.js?v=audiofix410-20260830",
  "./assets/js/scripts.js?v=audiofix410-20260830",
  "./assets/fonts/antique-olive-nord.woff2",
  "./manifest.webmanifest",
  "./data/catalog.json?v=audiofix410-20260830",
  "./data/track-durations.json?v=audiofix410-20260830",
  "./data/tracks.json?v=audiofix410-20260830",
  ...
  "./assets/branding/playlist-sign-moon-512.png",
  "./assets/branding/playlist-sign-sun-512.png",
  "./assets/branding/playlist-sign-snow-512.png",
  "./assets/branding/playlist-sign-falcon-512.png",
...
const OPTIONAL_SHELL_ASSETS = [
  "./assets/js/scripts.admin.js?v=audiofix410-20260830",
...
async function reconcileCoverCache() {
  const cache = await caches.open(COVERS_CACHE);
  const requests = await cache.keys();
  await Promise.all(requests.map(function (request) {
    const url = new URL(request.url);
    const relativePath = url.pathname.split("/").slice(-4).join("/");
    if (url.origin === self.location.origin && CANONICAL_COVER_PATHS.has(relativePath)) {
      return false;
    }
