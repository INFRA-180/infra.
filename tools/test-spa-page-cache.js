...
const SHELL_CACHE = "infra-shell-20260806-audio387-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260806-audio387");
...
async function main() {
  ...
  console.log("audiofix387 SPA page-cache tests: ok");
}
