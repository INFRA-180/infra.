...
const sandbox = {
  ...
  caches: {
    ...
    keys: () => Promise.resolve([
      ...
      "infra-shell-20260717-audio344-shell",
      "infra-shell-20260717-audio344-runtime"
    ]),
    delete: (name) => {
...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix344-20260717"));
  ...
  assert(!deletedCaches.includes("infra-shell-20260717-audio344-shell"));
  assert(!deletedCaches.includes("infra-shell-20260717-audio344-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260717-audio344");
