...
const sandbox = {
  ...
  caches: {
    ...
    keys: () => Promise.resolve([
      ...
      "infra-shell-20260807-audio390-shell",
      "infra-shell-20260807-audio390-runtime"
    ]),
    delete: (name) => {
...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix390-20260807"));
  assert(
  ...
  assert(!deletedCaches.includes("infra-shell-20260807-audio390-shell"));
  assert(!deletedCaches.includes("infra-shell-20260807-audio390-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260807-audio390");
