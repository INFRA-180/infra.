...
const SHELL_CACHE = "infra-shell-20260719-audio355-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260719-audio355");
...
async function main() {
  ...
  console.log("audiofix355 SPA page-cache tests: ok");
}
