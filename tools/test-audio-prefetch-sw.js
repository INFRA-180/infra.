...
const sandbox = {
  ...
  caches: {
    ...
    keys: () => Promise.resolve([
      ...
      "infra-shell-20260717-audio348-shell",
      "infra-shell-20260717-audio348-runtime"
    ]),
    delete: (name) => {
...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix348-20260717"));
  assert(
  ...
  assert(!deletedCaches.includes("infra-shell-20260717-audio348-shell"));
  assert(!deletedCaches.includes("infra-shell-20260717-audio348-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260717-audio348");
