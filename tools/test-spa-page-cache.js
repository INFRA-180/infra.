...
const SHELL_CACHE = "infra-shell-20260823-audio402-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260823-audio402");
...
async function main() {
  ...
  console.log("audiofix402 SPA page-cache tests: ok");
}
