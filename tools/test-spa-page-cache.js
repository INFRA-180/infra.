...
const SHELL_CACHE = "infra-shell-20260718-audio350-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260718-audio350");
...
async function main() {
  ...
  console.log("audiofix350 SPA page-cache tests: ok");
}
