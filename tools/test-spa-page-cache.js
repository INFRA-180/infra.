...
const SHELL_CACHE = "infra-shell-20260717-audio344-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260717-audio344");
...
async function main() {
  ...
  console.log("audiofix344 SPA page-cache tests: ok");
}
