...
const SHELL_CACHE = "infra-shell-20260724-audio371-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260724-audio371");
...
async function main() {
  ...
  console.log("audiofix371 SPA page-cache tests: ok");
}
