...
const SHELL_CACHE = "infra-shell-20260724-audio370-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260724-audio370");
...
async function main() {
  ...
  console.log("audiofix370 SPA page-cache tests: ok");
}
