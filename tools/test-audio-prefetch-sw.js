...
const sandbox = {
  ...
  caches: {
    ...
    keys: () => Promise.resolve([
      ...
      "infra-shell-20260720-audio364-shell",
      "infra-shell-20260720-audio364-runtime"
    ]),
    delete: (name) => {
...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix364-20260720"));
  assert(
  ...
  assert(!deletedCaches.includes("infra-shell-20260720-audio364-shell"));
  assert(!deletedCaches.includes("infra-shell-20260720-audio364-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260720-audio364");
