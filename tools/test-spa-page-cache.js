...
const SHELL_CACHE = "infra-shell-20260805-audio384-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260805-audio384");
...
async function main() {
  ...
  console.log("audiofix384 SPA page-cache tests: ok");
}
