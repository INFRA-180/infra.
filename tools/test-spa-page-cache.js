...
const SHELL_CACHE = "infra-shell-20260720-audio363-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260720-audio363");
...
async function main() {
  ...
  console.log("audiofix363 SPA page-cache tests: ok");
}
