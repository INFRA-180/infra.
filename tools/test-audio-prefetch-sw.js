...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix372-20260724"));
  assert(
  ...
  assert(!deletedCaches.includes("infra-shell-20260724-audio372-shell"));
  assert(!deletedCaches.includes("infra-shell-20260724-audio372-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260724-audio372");
