...
const sandbox = {
  ...
  caches: {
    ...
    keys: () => Promise.resolve([
      ...
      "infra-shell-20260801-audio376-shell",
      "infra-shell-20260801-audio376-runtime"
    ]),
    delete: (name) => {
...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix376-20260801"));
  assert(
  ...
  assert(!deletedCaches.includes("infra-shell-20260801-audio376-shell"));
  assert(!deletedCaches.includes("infra-shell-20260801-audio376-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260801-audio376");
