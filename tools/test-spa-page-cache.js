...
const SHELL_CACHE = "infra-shell-20260822-audio398-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260822-audio398");
...
async function main() {
  ...
  console.log("audiofix398 SPA page-cache tests: ok");
}
