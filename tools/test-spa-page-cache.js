...
const SHELL_CACHE = "infra-shell-20260717-audio343-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260717-audio343");
...
async function main() {
  ...
  console.log("audiofix343 SPA page-cache tests: ok");
}
