...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix366-20260722"));
  assert(
  ...
  assert(!deletedCaches.includes("infra-shell-20260722-audio366-shell"));
  assert(!deletedCaches.includes("infra-shell-20260722-audio366-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260722-audio366");
