...
const SHELL_CACHE = "infra-shell-20260717-audio347-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260717-audio347");
...
async function main() {
  ...
  console.log("audiofix347 SPA page-cache tests: ok");
}
