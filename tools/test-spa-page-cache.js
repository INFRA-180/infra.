...
const SHELL_CACHE = "infra-shell-20260722-audio366-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260722-audio366");
...
async function main() {
  ...
  console.log("audiofix366 SPA page-cache tests: ok");
}
