...
const SHELL_CACHE = "infra-shell-20260724-audio373-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260724-audio373");
...
async function main() {
  ...
  console.log("audiofix373 SPA page-cache tests: ok");
}
