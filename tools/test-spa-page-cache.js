...
const SHELL_CACHE = "infra-shell-20260822-audio397-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260822-audio397");
...
async function main() {
  ...
  console.log("audiofix397 SPA page-cache tests: ok");
}
