...
const SHELL_CACHE = "infra-shell-20260718-audio349-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260718-audio349");
...
async function main() {
  ...
  console.log("audiofix349 SPA page-cache tests: ok");
}
