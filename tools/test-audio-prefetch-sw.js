...
const sandbox = {
  ...
  caches: {
    ...
    keys: () => Promise.resolve([
      ...
      "infra-shell-20260719-audio361-shell",
      "infra-shell-20260719-audio361-runtime"
    ]),
    delete: (name) => {
...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix361-20260719"));
  assert(
  ...
  assert(!deletedCaches.includes("infra-shell-20260719-audio361-shell"));
  assert(!deletedCaches.includes("infra-shell-20260719-audio361-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260719-audio361");
