...
const SHELL_CACHE = "infra-shell-20260718-audio351-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260718-audio351");
...
async function main() {
  ...
  console.log("audiofix351 SPA page-cache tests: ok");
}
