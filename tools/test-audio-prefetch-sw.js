...
const sandbox = {
  ...
  caches: {
    ...
    keys: () => Promise.resolve([
      ...
      "infra-shell-20260720-audio362-shell",
      "infra-shell-20260720-audio362-runtime"
    ]),
    delete: (name) => {
...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix362-20260720"));
  assert(
  ...
  assert(!deletedCaches.includes("infra-shell-20260720-audio362-shell"));
  assert(!deletedCaches.includes("infra-shell-20260720-audio362-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260720-audio362");
