...
const SHELL_CACHE = "infra-shell-20260822-audio396-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260822-audio396");
...
async function main() {
  ...
  console.log("audiofix396 SPA page-cache tests: ok");
}
