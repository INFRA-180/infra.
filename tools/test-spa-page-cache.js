...
const SHELL_CACHE = "infra-shell-20260724-audio369-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260724-audio369");
...
async function main() {
  ...
  console.log("audiofix369 SPA page-cache tests: ok");
}
