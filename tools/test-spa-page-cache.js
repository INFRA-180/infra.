...
const SHELL_CACHE = "infra-shell-20260719-audio361-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260719-audio361");
...
async function main() {
  ...
  console.log("audiofix361 SPA page-cache tests: ok");
}
