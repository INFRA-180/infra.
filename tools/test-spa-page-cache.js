...
const SHELL_CACHE = "infra-shell-20260807-audio390-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260807-audio390");
...
async function main() {
  ...
  console.log("audiofix390 SPA page-cache tests: ok");
}
