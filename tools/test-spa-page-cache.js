...
const SHELL_CACHE = "infra-shell-20260807-audio389-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260807-audio389");
...
async function main() {
  ...
  console.log("audiofix389 SPA page-cache tests: ok");
}
