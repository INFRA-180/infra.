...
const SHELL_CACHE = "infra-shell-20260806-audio386-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260806-audio386");
...
async function main() {
  ...
  console.log("audiofix386 SPA page-cache tests: ok");
}
