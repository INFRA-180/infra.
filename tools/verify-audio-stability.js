...
const shellRelease = "infra-shell-20260802-audio379";
const cssRelease = "audiofix379-20260802";
...
expect(sw.includes(`const VERSION = "${shellRelease}"`), "Service Worker cache version is not audio379");
...
expect(cssHash === frozenCssSha256, "styles.css differs from the restored pre-Clear-HUD geometry");
