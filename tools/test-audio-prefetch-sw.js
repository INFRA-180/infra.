...
const sandbox = {
  ...
  caches: {
    ...
    keys: () => Promise.resolve([
      ...
      "infra-shell-20260718-audio349-shell",
      "infra-shell-20260718-audio349-runtime"
    ]),
    delete: (name) => {
...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix349-20260718"));
  assert(
  ...
  assert(!deletedCaches.includes("infra-shell-20260718-audio349-shell"));
  assert(!deletedCaches.includes("infra-shell-20260718-audio349-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260718-audio349");
