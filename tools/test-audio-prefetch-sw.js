...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix370-20260724"));
  assert(
  ...
  assert(!deletedCaches.includes("infra-shell-20260724-audio370-shell"));
  assert(!deletedCaches.includes("infra-shell-20260724-audio370-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260724-audio370");
