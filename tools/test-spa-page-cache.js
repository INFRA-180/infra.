...
const SHELL_CACHE = "infra-shell-20260805-audio385-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260805-audio385");
...
async function main() {
  ...
  console.log("audiofix385 SPA page-cache tests: ok");
}
