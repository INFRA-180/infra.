...
const sandbox = {
  ...
  caches: {
    ...
    keys: () => Promise.resolve([
      ...
      "infra-shell-20260807-audio389-shell",
      "infra-shell-20260807-audio389-runtime"
    ]),
    delete: (name) => {
...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix389-20260807"));
  assert(
  ...
  assert(!deletedCaches.includes("infra-shell-20260807-audio389-shell"));
  assert(!deletedCaches.includes("infra-shell-20260807-audio389-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260807-audio389");
