...
const SHELL_CACHE = "infra-shell-20260719-audio358-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260719-audio358");
...
async function main() {
  ...
  console.log("audiofix358 SPA page-cache tests: ok");
}
