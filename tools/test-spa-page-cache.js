...
const SHELL_CACHE = "infra-shell-20260821-audio395-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260821-audio395");
...
async function main() {
  ...
  console.log("audiofix395 SPA page-cache tests: ok");
}
