...
const SHELL_CACHE = "infra-shell-20260720-audio362-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260720-audio362");
...
async function main() {
  ...
  console.log("audiofix362 SPA page-cache tests: ok");
}
