...
const SHELL_CACHE = "infra-shell-20260802-audio383-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260802-audio383");
...
async function main() {
  ...
  console.log("audiofix383 SPA page-cache tests: ok");
}
