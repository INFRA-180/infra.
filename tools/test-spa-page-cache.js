...
const SHELL_CACHE = "infra-shell-20260720-audio365-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260720-audio365");
...
async function main() {
  ...
  console.log("audiofix365 SPA page-cache tests: ok");
}
