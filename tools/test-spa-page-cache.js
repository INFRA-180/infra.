...
const SHELL_CACHE = "infra-shell-20260815-audio392-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260815-audio392");
...
async function main() {
  ...
  console.log("audiofix392 SPA page-cache tests: ok");
}
