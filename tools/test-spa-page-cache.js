...
const SHELL_CACHE = "infra-shell-20260724-audio372-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260724-audio372");
...
async function main() {
  ...
  console.log("audiofix372 SPA page-cache tests: ok");
}
