...
const SHELL_CACHE = "infra-shell-20260822-audio400-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260822-audio400");
...
async function main() {
  ...
  console.log("audiofix400 SPA page-cache tests: ok");
}
