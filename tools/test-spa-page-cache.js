...
const SHELL_CACHE = "infra-shell-20260719-audio354-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260719-audio354");
...
async function main() {
  ...
  console.log("audiofix354 SPA page-cache tests: ok");
}
