...
const SHELL_CACHE = "infra-shell-20260717-audio348-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260717-audio348");
...
async function main() {
  ...
  console.log("audiofix348 SPA page-cache tests: ok");
}
