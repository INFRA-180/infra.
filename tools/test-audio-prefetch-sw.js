...
const sandbox = {
  ...
  caches: {
    ...
    keys: () => Promise.resolve([
      ...
      "infra-shell-20260806-audio387-shell",
      "infra-shell-20260806-audio387-runtime"
    ]),
    delete: (name) => {
...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix387-20260806"));
  assert(
  ...
  assert(!deletedCaches.includes("infra-shell-20260806-audio387-shell"));
  assert(!deletedCaches.includes("infra-shell-20260806-audio387-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260806-audio387");
