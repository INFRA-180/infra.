...
const SHELL_CACHE = "infra-shell-20260719-audio359-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260719-audio359");
...
async function main() {
  ...
  console.log("audiofix359 SPA page-cache tests: ok");
}
