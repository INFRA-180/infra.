...
const SHELL_CACHE = "infra-shell-20260719-audio360-shell";
...
async function testInstalledShellWinsWithoutNetwork() {
  ...
  assert.equal(result.workerVersion, "infra-shell-20260719-audio360");
...
async function main() {
  ...
  console.log("audiofix360 SPA page-cache tests: ok");
}
