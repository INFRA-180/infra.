...
const sandbox = {
  ...
  caches: {
    ...
    keys: () => Promise.resolve([
      ...
      "infra-shell-20260822-audio398-shell",
      "infra-shell-20260822-audio398-runtime"
    ]),
    delete: (name) => {
...
(async function () {
  ...
  assert(installedShellAssets.includes("./assets/js/scripts.js?v=audiofix398-20260822"));
  assert(
  ...
  assert(!deletedCaches.includes("infra-shell-20260822-audio398-shell"));
  assert(!deletedCaches.includes("infra-shell-20260822-audio398-runtime"));
  ...
  assert.strictEqual(response.headers.get("X-Infra-SW-Version"), "infra-shell-20260822-audio398");
